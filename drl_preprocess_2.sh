...
for file  in `ls '/cylon/afniproc/rrl' | grep rrl`; do
        ...
        cd '/cylon/afniproc/rrl/'$file'/s2/fmri/drl'
        ...
        if [ -e drl1+orig.HEAD ] ; then rm -rf drl?+orig* ; fi
        ...
        #start 6
        #end 287
	3dTcat -prefix drl1 'drl_s2_1+orig[6..286]'
	3dTcat -prefix drl2 'drl_s2_2+orig[6..286]'
